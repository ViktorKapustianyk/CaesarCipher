...
public class BruteForce {
    private static final List<String> WORDS = Arrays.asList(
            "the", "and", "is", "are", "in", "at", "that", "this", "for", "to", "on", "with", "it", "of", "an", "as", "be", "was", "or", "by", "from", "not", "but", "you", "all", "they", "we", "our", "your", "so", "if", "out", "about", "more", "has", "have", "what", "when", "where", "who", "which", "why", "how", "many", "much", "some", "any", "no", "just", "like", "into", "up", "down", "into", "over", "under", "there", "then", "her", "him", "his", "hers", "their", "them", "because", "could", "would", "should", "will", "can", "may", "might"
    );
